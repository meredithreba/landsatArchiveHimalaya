clear;clc;
traj_matrix=dlmread('/home/fas/seto/xl533/scratch60/grace6/traj_0_slice.txt');
...
idx = kmeans(urbanTraj,10);   %kmeans in 10 clusters

fid=fopen('/home/fas/seto/xl533/scratch60/grace6/urban_only_traj.txt','w');
fprintf(fid,'%d ',startDate,endDate);
fprintf(fid,'\n ');
for i=1:counturban
    fprintf(fid,'%d ',urbanTraj(i,:));
    fprintf(fid,'\n ');
end
fclose(fid);

fid=fopen('/home/fas/seto/xl533/scratch60/grace6/kmeans_out.txt','w');
fprintf(fid,'%d ',idx);
fclose(fid);
