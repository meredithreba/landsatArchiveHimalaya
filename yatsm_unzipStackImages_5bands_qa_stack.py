...
import shutil
###################################################################################################################################
directory = r"/home/fas/seto/bc643/scratch60/grace1/micro/CongoZipped"
os.chdir(directory)
files = os.listdir(directory)
###################################################################################################################################
outdirbase= r'/home/fas/seto/bc643/scratch60/grace1/Congo_junk'
...
##################################################################################################################################
thefile = open('/home/fas/seto/bc643/scratch60/grace1/'+ 'test_Congo.txt', 'w')
...
##################################################################################################################################
os.system('gdalbuildvrt -separate -input_file_list /home/fas/seto/bc643/scratch60/grace1/test_Congo.txt /home/fas/seto/bc643/scratch60/grace1/out_Congo.vrt')
###########################################################################################################################
os.system('gdal_translate /home/fas/seto/bc643/scratch60/grace1/out_Congo.vrt -b 1 -of GTiff /home/fas/seto/bc643/scratch60/grace1/out_Congo.tif')

print "All Done"

##################################################################################################################################
outdir = '/home/fas/seto/bc643/scratch60/grace1/Congo_Imagestack'
...
for x in range(0,len(alldirs)):	
	...
	if "LC" in presentdir:
		files = [ y for y in filesinpresentdir if "sr_band3" in y or "sr_band4" in y or "sr_band5" in y or "sr_band6" in y or "sr_band7" in y]
		...
		###########################################################################################################################
		files.append(r"/home/fas/seto/bc643/scratch60/grace1/out_Congo.tif")
		###########################################################################################################################
		outdir = '/home/fas/seto/bc643/scratch60/grace1/Congo_Imagestack/' + presentdir.split('/')[8]
		if (os.path.exists(outdir)):
			...
			outds = None
			#############
			outds1 = gdal.Translate(outtif2,outtif,bandList = [1,2,3,4,5,6])
			outds1 = None
		...
		files = [ y for y in filesinpresentdir if "sr_band2" in y or "sr_band3" in y or "sr_band4" in y or "sr_band5" in y or "sr_band7" in y]
		files = [os.path.join(presentdir,z) for z in files]
		files.sort()
		filesqa = [ y for y in filesinpresentdir if "pixel_qa" in y]
		filesqa = [os.path.join(presentdir,z) for z in filesqa]
