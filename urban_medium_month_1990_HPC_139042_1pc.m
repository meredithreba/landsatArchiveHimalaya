clear;clc;
array=load('/home/fas/seto/xl533/scratch60/grace7/out_within.txt');
[r,c]=size(array);
...
urban_index=load('/home/fas/seto/xl533/scratch60/grace7/139042_urbtraj_WithinShpnoOverlay_1pct_rand.txt');
...
fid=fopen('/home/fas/seto/xl533/scratch60/grace7/traj_urban_medium_front_end_month_1990_1pc.txt','w');
...
for k=1:r_u-1
    ...
    for m=1:desired_len
        traj_month(k,m+2)=traj_day(1,round(m*30.4375)-1); %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    end
