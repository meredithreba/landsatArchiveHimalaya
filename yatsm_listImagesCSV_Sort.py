...
imdir = r'/home/fas/seto/bc643/project/ImageStack/ImageStack_145040'
...
with open("/home/fas/seto/bc643/project/csvlist/p145r040.csv",'wb') as resultFile:  #'wb': write and binary; The with statement clarifies code that previously would use try...finally blocks to ensure that clean-up code is executed.
...
#reader = csv.reader(open("/home/fas/seto/bc643/project/csvlist/p145r040.csv"), delimiter=",")
reader = csv.reader(open("/home/fas/seto/bc643/project/csvlist/p145r040.csv"), delimiter=",")
sortedlist = sorted(reader, key=lambda row: row[0], reverse=False)

with open("/home/fas/seto/bc643/project/csvlist/p145r040_sortedbydate1.csv",'wb') as sortedResultFile:  #'wb': write and binary; The with statement clarifies code that previously would use try...finally blocks to ensure that clean-up code is executed.
