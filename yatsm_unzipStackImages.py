# -*- coding: utf-8 -*-
"""
Created on Sat Oct 07 18:20:13 2017
...
import os
os.chdir(r'C:\Users\mra37\Desktop\YATSM_related\YATSM_prepMaterials')
import unziplandsat
from osgeo import gdal
import shutil # module for file manipulation (copying, moving, deleting, etc)

# set the directory
directory = r"Z:\NASA_Himalaya_Project\Satellite_imagery\ETM\p146r039"
...
os.system('gdalbuildvrt -separate -input_file_list Z:\\NASA_Himalaya_Project\\Satellite_imagery\\test.txt Z:\\NASA_Himalaya_Project\\Satellite_imagery\\out.vrt')
